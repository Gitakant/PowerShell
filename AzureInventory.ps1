...
try {
 ...
 { 
    ...
    Connect-AzAccount -TenantId '4da45da6-7197-49e3-ba82-735012065e57'
    if ($SubscriptionId.Length -eq 0) {
        $subscriptions = Get-AzSubscription -TenantId '4da45da6-7197-49e3-ba82-735012065e57' -ErrorAction Stop
    } else {
        $subscriptions = Get-AzSubscription -SubscriptionId $SubscriptionId -TenantId '4da45da6-7197-49e3-ba82-735012065e57' -ErrorAction Stop
    }    
}
...
foreach ($subscription in $subscriptions) {
    ...
    if ($ressources.Length -gt 0) {
        ...
        $ressources | Export-Csv -Path $pathInventory -NoTypeInformation
        ...
        if ($marketplaceItems.Length -gt 0) {
            ...
            $marketplaceItems | Export-Csv -Path $pathMarketplace -NoTypeInformation
        }
    }
}